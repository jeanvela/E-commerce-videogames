...
import { inferHandlerInput, inferProcedureOutput, ProcedureType } from './types';
/** @internal **/
 ...
 * @internal
 */
type inferHandlerFn<TProcedures extends ProcedureRecord> = <TProcedure extends TProcedures[TPath], TPath extends keyof TProcedures & string>(path: TPath, ...args: inferHandlerInput<TProcedure>) => Promise<inferProcedureOutput<TProcedure>>;
 ...
 * @internal
 */
type RouterCaller<TDef extends AnyRouterDef> = (ctx: TDef['_config']['$types']['ctx']) => {
    /**
     * @deprecated
     */
