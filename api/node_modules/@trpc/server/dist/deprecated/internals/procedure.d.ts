...
export type ProcedureParserCustomValidatorEsque<TType> = (input: unknown) => TType | Promise<TType>;
...
export type ProcedureParser<TType> = ProcedureParserYupEsque<TType> | ProcedureParserSuperstructEsque<TType> | ProcedureParserCustomValidatorEsque<TType> | ProcedureParserMyZodEsque<TType>;
...
export type CreateProcedureOptions<TContext, TMeta = undefined, TInput = undefined, TParsedInput = undefined, TOutput = undefined, TParsedOutput = undefined> = CreateProcedureWithInputOutputParser<TContext, TMeta, TInput, TParsedInput, TOutput, TParsedOutput> | CreateProcedureWithInput<TContext, TMeta, TInput, TOutput> | CreateProcedureWithoutInput<TContext, TMeta, TOutput, TParsedOutput>;
